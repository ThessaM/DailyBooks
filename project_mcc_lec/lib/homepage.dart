...
import 'package:project_mcc_lec/book.dart';
import 'package:project_mcc_lec/bookdetailpage.dart';
...
[] navigasi floating action butto -> ke cart pages
*/
...
class _HomePageState extends State<HomePage> {
  ...
  final List <Book> books = [
    Book("Crooked House", "Agatha Christie", "60.000", "Young Sophia returns after the war to find her grandfather poisoned and a family filled with suspects. Luckily her fiancé, Charles, is the son of the assistant commissioner of Scotland Yard.", "assets/Book/CrookedHouse_AgathaChristie.jpg", 4.5),
    Book("The Case Book of Sherlock Holmes", "Sir Arthur Conan Doyle", "86.000", "the final set of twelve Sherlock Holmes short stories", "assets/Book/TheCaseBookOfSherlockHolmes_SirArthur.jpg", 5),
    Book("Sophie's World", "Jostein Gaarder", "72.000", "Sophie Amundsen, a Norwegian teenager, who is introduced to the history of philosophy as she is asked, 'Who Are You?'", "assets/Book/DuniaSophie_JosteinGaarder.jpg", 4.5)
  ];
...
class BookSearchDelegate extends SearchDelegate{
  ...
  // => BookListGridView(bookLists: books);
  // Center(
  //   child: Text(
  //     query,
...
class BookListGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   children: [
    //     BookListCard(bookdetail: bookLists[0]),
    //     BookListCard(bookdetail: bookLists[1]),
    //     BookListCard(bookdetail: bookLists[2]),
    //   ],
    //   controller: ScrollController(),
